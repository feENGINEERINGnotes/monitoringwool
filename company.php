...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO ram (wool_type, fiber_length, fiber_diameter,staple_length, cleanliness, $Remarks)
            VALUES ('$wool_type', $fiber_length, $fiber_diameter,$staple_length, $cleanliness, $Remarks)";
...
<html>
<head>
    <title>Company Assurance Form</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <form method="post" action="farm.php">
            ...
            <input type="text" id="Remarks" name="Remarks" min="0" max="100" required>
