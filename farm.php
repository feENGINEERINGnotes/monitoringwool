...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO ram (wool_type, fiber_length, fiber_diameter,staple_length, cleanliness)
...
<html>
<head>
    <title>Wool Quality Parameters Form</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1>Wool Quality Parameters Form</h1>
        <form method="post" action="farm.php">
            ...
            <label for="Lattitude">Lattitude(in digits):</label>
            <input type="number" id="Lattitude" name="Lattitude" min="0" max="100" required>

            <label for="Longitude">Longitude(in digits):</label>
            <input type="number" id="Longitude" name="Longitude" min="0" max="100" required>
